// scripts/governance/gen_safe_phase5.js
// Generates a Safe Transaction Builder JSON for the Phase 5 Timelock.scheduleBatch call.
// Output: safe_phase5.json in the project root.
"use strict";
...
// ── Exact values from schedule_phase5.js run ─────────────────────────────────
...
const safeJson = {
  ...
  createdAt: Date.now(),
  meta: {
    name: "OBN v9.3 Phase 5 — Vault wiring + nonprofit approvals",
    description: `Timelock.scheduleBatch: setGovernance x2 + setApprovedNonprofit x11. opId: ${OP_ID}`,
...
const outPath = path.join(__dirname, "../../../safe_phase5.json");
...
console.log(`\nImport this file in Safe → New Transaction → Transaction Builder → drag-drop or paste JSON.`);
